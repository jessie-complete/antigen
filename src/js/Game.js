...
export class Game {
    ...
    draw(dt) {
        this.renderer.draw(this.state, dt); // Draws background/landscape

        // Draw Turtle (Always visible except maybe menu? Let's show in menu too)
        if (this.state !== 'MENU') {
            // For FALLING state, we pass custom Y
